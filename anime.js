...
async function fetchDataWithCookie() {
  try {
    ...
    $(
      "div > div.postbody > div.bixbox.bbnofrm > div.listupd.normal > div.excstf > article",
      ...
      getEpisodeLink.push(
        ...
        .then(() => axios.get(slug))
          .then((response) => {
            ...
            const desc = $anime(
              "div.single-info.bixbox > div.infox > div.info-content > div.desc.mindes",
            ).text();
            let krakenLinks = "-";
              ...
              getkrakenDownload.push(
                axios
                  ...
                  .then((response) => {
                    ...
                    const getKrakenVID = $kraken("video#my-video")
                      .attr("data-src-url")
                      .replace("//", "https://");
